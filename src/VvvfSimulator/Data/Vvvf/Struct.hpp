...
namespace VvvfSimulator::Data::Vvvf
{
	...
	private:
		...
		std::optional<TPattern> findCurrentPattern(
	...
	using AcceleratePattern = Struct::PulseControl;
	...
	using YamlVvvfSoundData = Struct;
	using YamlControlData = Struct::PulseControl;
	using YamlPulseMode = Struct::PulseControl::Pulse;
	using YamlMovingValue = Struct::PulseControl::FunctionValue;
}
